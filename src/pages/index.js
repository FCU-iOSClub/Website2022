        ...
        <div className="py-5 md:px-32 grid grid-rows-1 md:grid-cols-2 md:p-10 md:space-x-10 justify-center items-center">
          ...
          <div className="w-full self-center">
            ...
            <p className="py-3 md:px-12 text-gray-700 text-justify">
              是全臺首個獲得 Apple
              官方認證的社團，也是一個結合學術的志工性社團。每年暑假社員們會有國際交流的機會，到海外參加比賽，和不同國家的學生進行合作活動與技術交流。
            </p>
          </div>
        ...
        <div className="py-5 md:px-32 grid grid-rows-1 md:grid-cols-2 md:p-10 md:space-x-10 justify-center items-center">
          <div className="w-full self-center">
            ...
            <p className="py-3 text-gray-700 text-justify">
              ...
              學生挑戰賽及行動應用創新賽等比賽取得佳績，更在各個領域嶄露頭角。社團不僅提供
              RTC
              認證的社課資源，還有定期舉辦講座、WorkShop、社內競賽，增強團隊實力。除此之外，更有野餐、社遊和期末聚等，超多活動等你們來參加！身為志工性社團的我們，還會和相關機構及國小一同舉辦志工營隊，將在社團內所學回饋社會。
            </p>
          </div>
