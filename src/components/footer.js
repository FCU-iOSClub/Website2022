    ...
    <div className="bg-footerbg w-full py-24 px-12">
      <div className="grid grid-cols-1 flex-col md:grid-cols-4 justify-center gap-8 md:gap-24 md:px-16">
        <div>
          ...
          <p className="text-gray-300 my-6">Feng Chia University</p>
        </div>
        <div className="flex flex-col gap-1">
          <p className="font-bold text-gray-900">Our Activities</p>
          <a href="/404" className="text-gray-300">
            行事曆
          </a>
          <a href="/gallery_list" className="text-gray-300">
            活動相簿
          </a>
          <a href="/404" className="text-gray-300">
            報名活動
        ...
        <div className="flex flex-col gap-1">
          ...
          {communityList.map((item, index) => (
            <a href={item.href} className="text-gray-300" key={index}>
      ...
      <div className="pt-12 text-gray-300 text-center flex flex-col md:flex-row justify-center items-center">
